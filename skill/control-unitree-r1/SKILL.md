...
Compositions: 欢迎, 问候学生, 邀请回答, 回答正确, 再试一次, 开始上课, 结束课程, 能力展示, 鼓掌欢迎, 欢呼比耶.

## Rules

- Plan a list of catalog atoms for any instruction. Never output joint angles, `LowCmd`, DDS topics, Shell, or Python for the robot.
