...
const std::map<std::string, Motion> kMotions = {
  {"wrist_wave", {{1.2f,O({{RWR,0.55f}}),0.05f},{0.45f,O({{RWR,-0.45f}}),0.05f},{0.45f,O({{RWR,0.55f}}),0.2f}}},
  {"wrist_wave_left", {{1.2f,O({{LWR,-0.55f}}),0.05f},{0.45f,O({{LWR,0.45f}}),0.05f},{0.45f,O({{LWR,-0.55f}}),0.2f}}},
  {"wave_left", {{1.6f,O({{LSP,-0.50f},{LSR,0.20f},{LE,0.48f}}),0.1f},{0.5f,O({{LSP,-0.50f},{LSR,0.20f},{LE,0.48f},{LWR,0.65f}}),0.05f},{0.5f,O({{LSP,-0.50f},{LSR,0.20f},{LE,0.48f},{LWR,-0.45f}}),0.05f},{0.5f,O({{LSP,-0.50f},{LSR,0.20f},{LE,0.48f},{LWR,0.65f}}),0.2f}}},
  {"wave_right", {{1.6f,O({{RSP,-0.50f},{RSR,-0.20f},{RE,0.48f}}),0.1f},{0.5f,O({{RSP,-0.50f},{RSR,-0.20f},{RE,0.48f},{RWR,0.65f}}),0.05f},{0.5f,O({{RSP,-0.50f},{RSR,-0.20f},{RE,0.48f},{RWR,-0.45f}}),0.05f},{0.5f,O({{RSP,-0.50f},{RSR,-0.20f},{RE,0.48f},{RWR,0.65f}}),0.2f}}},
  {"raise_hand_left", {{2.0f,O({{LSP,-0.48f},{LSR,0.18f},{LE,0.32f}}),0.8f}}},
  {"raise_hand_right", {{2.0f,O({{RSP,-0.48f},{RSR,-0.18f},{RE,0.32f}}),0.8f}}},
  {"salute_left", {{2.0f,O({{LSP,-0.40f},{LSR,0.16f},{LE,0.55f},{LWR,0.20f}}),0.8f}}},
  {"salute_right", {{2.0f,O({{RSP,-0.40f},{RSR,-0.16f},{RE,0.55f},{RWR,-0.20f}}),0.8f}}},
  {"open_arms", {{2.0f,O({{LSR,0.38f},{RSR,-0.38f},{LE,0.18f},{RE,0.18f}}),0.8f}}},
  {"nod", {{1.1f,O({{HP,0.20f}}),0.1f},{0.8f,O({{HP,-0.12f}}),0.15f},{0.8f,O({{HP,0.18f}}),0.2f}}},
  {"look", {{1.5f,O({{HY,0.32f}}),0.6f}}},
  {"look_right", {{1.5f,O({{HY,-0.32f}}),0.6f}}},
  {"shake_head", {{1.1f,O({{HY,0.28f}}),0.08f},{0.8f,O({{HY,-0.28f}}),0.08f},{0.8f,O({{HY,0.22f}}),0.2f}}},
  {"listen_left", {{1.6f,O({{HY,0.30f},{HP,0.06f}}),0.9f}}},
  {"listen_right", {{1.6f,O({{HY,-0.30f},{HP,0.06f}}),0.9f}}},
  {"present_left", {{2.0f,O({{LSP,-0.28f},{LSR,0.18f},{LE,0.28f},{HY,0.12f}}),0.8f}}},
  {"present_right", {{2.0f,O({{RSP,-0.28f},{RSR,-0.18f},{RE,0.28f},{HY,-0.12f}}),0.8f}}},
  {"hands_forward", {{2.0f,O({{LSP,-0.30f},{RSP,-0.30f},{LE,0.22f},{RE,0.22f}}),0.7f}}},
  {"ready_pose", {{1.2f,O({}),0.2f}}},
  {"small_cheer", {{1.8f,O({{LSP,-0.42f},{RSP,-0.42f},{LE,0.32f},{RE,0.32f}}),0.5f}}},
  {"dual_arm_gesture", {{1.6f,O({{LSP,0.40f},{RSP,-0.40f}}),0.4f},{1.2f,O({{LSP,0.40f},{RSP,-0.40f},{LWR,0.72f},{RWR,-0.72f}}),0.6f}}},
  {"clap", {{1.4f,O({{LSP,-0.24f},{RSP,-0.24f},{LSR,0.14f},{RSR,-0.14f},{LE,0.45f},{RE,0.45f}}),0.1f},{0.32f,O({{LSP,-0.24f},{RSP,-0.24f},{LSR,0.14f},{RSR,-0.14f},{LE,0.45f},{RE,0.45f},{LWR,0.50f},{RWR,-0.50f}}),0.04f},{0.32f,O({{LSP,-0.24f},{RSP,-0.24f},{LSR,0.14f},{RSR,-0.14f},{LE,0.45f},{RE,0.45f},{LWR,-0.28f},{RWR,0.28f}}),0.04f},{0.32f,O({{LSP,-0.24f},{RSP,-0.24f},{LSR,0.14f},{RSR,-0.14f},{LE,0.45f},{RE,0.45f},{LWR,0.50f},{RWR,-0.50f}}),0.2f}}},
  {"come_here", {{1.4f,O({{RSP,-0.40f},{RSR,-0.14f},{RE,0.55f}}),0.08f},{0.4f,O({{RSP,-0.40f},{RSR,-0.14f},{RE,0.28f}}),0.04f},{0.4f,O({{RSP,-0.40f},{RSR,-0.14f},{RE,0.55f}}),0.04f},{0.4f,O({{RSP,-0.40f},{RSR,-0.14f},{RE,0.28f}}),0.2f}}},
  {"point_left", {{1.8f,O({{LSP,-0.34f},{LSR,0.24f},{LE,0.12f},{HY,0.22f}}),0.8f}}},
  {"point_right", {{1.8f,O({{RSP,-0.34f},{RSR,-0.24f},{RE,0.12f},{HY,-0.22f}}),0.8f}}},
